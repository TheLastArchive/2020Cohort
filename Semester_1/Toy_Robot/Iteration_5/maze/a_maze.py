...
def sort_obstacle_list_into_rings(left, right, bottom, top):
    """
    ...
    for ring in range(9):
        ...
        obstacle_list.append(ring_obs)

    return list(reduce(lambda a, b: a+b, obstacle_list))
...
def get_obstacles():
    ...
    obstacle_list = sort_obstacle_list_into_rings(lef_ver, rig_ver, bot_hor, top_hor)
