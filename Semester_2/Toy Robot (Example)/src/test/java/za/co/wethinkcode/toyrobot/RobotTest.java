...
class RobotTest {
    ...
    void forwardforward() {
        Robot robot = new Robot("CrashTestDummy");
        Command forward10 = new ForwardCommand("10");
        assertTrue(robot.handleCommand(forward10));
        Command forward5 = new ForwardCommand("5");
    ...
    void tooFarForward() {
        Robot robot = new Robot("CrashTestDummy");
        Command forward1000 = new ForwardCommand("1000");
        assertTrue(robot.handleCommand(forward1000));
        assertEquals(Robot.CENTRE, robot.getPosition());
