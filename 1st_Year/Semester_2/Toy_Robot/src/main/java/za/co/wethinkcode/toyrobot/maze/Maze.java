...
public interface Maze {
    ...
    /**
     * command which creates the maze object based on the user's input
     * @param arg the user's input
     */
    void selectMaze(String arg);

    /**
     * generates the obstacles used for the given maze
     * @return obstacleList The list of obstacles used in the maze
     */
    List<Obstacle> generateMaze();

    /**
     * clears all the obstacles in the maze object
     */
    void clearObstacles();
}
